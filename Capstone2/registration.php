  ...
  <body class="menu-position-side menu-side-left full-screen">
	<div class="all-wrapper solid-bg-all">
		...
		<div class="layout-w">
		   ...
		   START - Main Menu
		   -------------------->
			<div class="menu-w selected-menu-color-light menu-has-selected-link menu-activated-on-click color-scheme-dark color-style-default sub-menu-color-light menu-position-side menu-side-left menu-layout-compact sub-menu-style-inside">
				<div class="logo-w">
			...
			<div class="content-w">
				...
				<div class="top-bar color-scheme-dark">
					 ...
					 <ul class="breadcrumb">
					   ...
					   <li class="breadcrumb-item">
						<a href="" class="text-white inactiveLink" >Laptop with retina screen</a>
					   </li>
					 </ul>
					 <!--------------------
					 END - Breadcrumbs
					...
					<div class="element-box">
						<div class="form-content">
							<div class="row">
								...
								<div class="col-md-6 p-1">
									<h5 class="form-header">
										List of Recently Registered Employees.
									</h5><br>
									<div class="table-responsive">
										<table id ="registered_list" width="100%" class="table table-striped table-lightfont table-compact">
										    <thead>
											   <tr>
											   		<th>#</th>	
													<th>Employee ID</th>
											...
											$row = $obj->fetch_data("Employee_Master ORDER BY id DESC");
